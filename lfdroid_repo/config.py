...
repo_url = "https://lfdroid.github.io/repo"
repo_name = "LFDroid - less free android repo"
repo_icon = "lfdroid-icon.png"
repo_description = """
LFDroid

stands for less free android repository

its based on the fdroid project and is an alternate repository whyich brings only free (not as im free beer but as im freedom (libre not (only) gratis)) and open source software to devices with the android operating system. The regulations/requierments for there repository are very high so this repository is an attemnt for to have some more (and more up to date) thinks on your phone. 
"""
...
archive_older = 0
archive_url = "https://"
archive_name = "LFDroid archive - less free android repo archive"
archive_icon = "lfdroid-icon.png"
archive_description = """
...
repo_keyalias = "treakis-debian-rechsud02"
...
# in text files!
keystorepass = "JpCNYZQcAOtjwULgGCRdnibvxFAyN3Me9RKqhJGOfHY="
...
keypass = "JpCNYZQcAOtjwULgGCRdnibvxFAyN3Me9RKqhJGOfHY="

# The distinguished name used for all keys.
keydname = "CN=treakis-debian-rechsud02, OU=F-Droid"
